...
#this is used to translate the sentence using the model.
class SequenceGenerator(object):
    ...
    #this is a function which iterates over the whole dataset batch wise.
    #this is like a iterator wrapper over an iterator, iterator is used instead of storing
    #dataset in a list because, if dataset is large then storing it in list may waste memory.
    ...
    def generate_batched_itr(self, data_itr, beam_size=None, maxlen_a=0.0, maxlen_b=None,
        ...
        Args:
            data_itr: is an object returned by eval_loader
        ...
        for sample in data_itr:
            #every batch sample is converted to variable before forward pass.
            ...
            if timer is not None:
                timer.start()
            #generate only needs src_tokens because rest should be generated by model itself in target length no.of steps.
